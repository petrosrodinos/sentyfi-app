...
import { type NotificationChannel } from "../../../interfaces/notification-channels";
...
export default function DangerZoneCard({ telegramChannel, onChannelDeleted }: DangerZoneCardProps) {
